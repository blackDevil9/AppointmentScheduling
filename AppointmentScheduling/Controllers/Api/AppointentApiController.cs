...
namespace AppointmentScheduling.Controllers.Api
{
    ...
    [ApiController]
    public class AppointentApiController : Controller
    {
        ...
        public AppointentApiController(IAppointmentService appointmentService, IHttpContextAccessor httpContextAccessor)
        {
